        ...
        return (
            <div style={divStyle}>
                {this.props.optionsList.map((option) =>
                    <button key={option.option} value={option.option} style={this.props.selectedList ? this.props.selectedList.includes(option.option) ? selectedStyle : disabledStyle : disabledStyle} type="button" className="btn btn-outline-dark  btn-icon-text" onClick={this.onClick}>
